            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX', 'somebooks'),
                ...
                */
                ...
                'hosts' => explode(' ', env('LDAP_HOSTS', '192.168.100.230')),
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'ou=usuarios,dc=somebooks,dc=local'),
